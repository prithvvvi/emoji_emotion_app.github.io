...
classifier=ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/vl09p0AVM/model.json',modelLoaded);
function modelLoaded()
{
    console.log('model has been succsesfully loaded');
}
function speak()
{
